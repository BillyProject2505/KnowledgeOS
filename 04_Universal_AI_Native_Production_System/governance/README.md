...
|---|---|---|---|---|
| 1 | `UAICP-FC-001` | `../foundation/UAICP-FC-001-foundational-concept-and-north-star.md` | Foundational intent and North Star | Published |
...
| 6 | `UAICP-CED-001` | `../research/UAICP-CED-001-project-concept-and-entity-discovery-model.md` | Concept and entity discovery | Published |
