...
## Canonical Subordinate Specifications

The following specification is canonically recognized as subordinate to UNIS. It does not form an additional UNIS rule layer and shall not be interpreted as an independent identification authority.

### DIS-CORE-001 — Decision Identification Specification v1.0

| Property | Canonical Value |
|---|---|
| Document ID | `DIS-CORE-001` |
| Title | Decision Identification Specification |
| Version | `1.0` |
| Status | `CANONICALLY LOCKED` |
| Authority Relationship | `SUBORDINATE TO UNIS` |
| Scope | Production Decision Identification |
| Rule Range | `DIS-001–DIS-036` |
| Independent Identification Authority | `NONE` |
| Independent Identifier Grammar | `NONE` |
...
UNIS-CORE-001
    ...
    │ canonical authority
    ▼
Applicable Identification Architecture
    │
    ▼
DIS-CORE-001 — Decision Identification Specification v1.0
    │
...
**Subordination rule:** DIS-CORE-001 may specialize the application of UNIS Identification rules to Production Decisions, but shall not override, redefine, contradict, independently extend, or replace UNIS.

**Important:** DIS-CORE-001 is a separate subordinate canonical document. Its rules shall not be interpreted as additional Universal UNIS rule layers.
...
| Current Materialization | `UNIS v1.4` |
