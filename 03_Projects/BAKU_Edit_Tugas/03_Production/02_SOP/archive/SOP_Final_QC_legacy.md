# ARCHIVED — SOP — Final Quality Control

> **Archive status:** Legacy / superseded
> **Original path:** `03_Production/02_SOP/SOP_Final_QC.md`
> **Original blob SHA:** `a781478bafb109fac8b3f6a9464fe129a287a350`
> **Superseded by:** `SOP-07_Final_QC_Delivery_and_Archive.md` and `QC-05_Final_QC.md`
> **Reason:** Legacy final-QC SOP retained for historical provenance only. It is not an active production authority.
