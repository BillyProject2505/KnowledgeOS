...
scope: Validated registration-record representations and traceability associated with current UNIR Registry Objects
purpose: Canonical documentary representation and traceability layer for validated UNIR registration records
parent_document: UNIR-REGISTRY-001 v1.0
source_basis: Validated registration readiness, decision, authorization, allocation, registration-event, reassessment, and related evidence artifacts established through D3-R1 through D3-R10 and the current UNIR-REGISTRY-001 v1.0 traceability state
...
**Parent Document:** `UNIR-REGISTRY-001 v1.0`  
...
**Canonical Repository Path:** NOT YET ASSIGNED
...
DIUA-DIC-000001
  ↓
UNIR-REG-EVT-DIUA-DIC-000001
```

**Allocation Event State:** RECORDED

This representation does not create:

- a DIUA Registry Object;
- a new DIC definition;
- a new Document Identifier Grammar;
- a new namespace;
- a sixth Registry Object.

The current allocated identifier state remains represented by `UNIR-REGISTRY-001`.
...
UDS construction, document materialization, canonicalization, and general publication/release records are outside the substantive registration-record scope of this document.
...
Accordingly, `UNIR-REGISTRATION-RECORD-001 v1.0` is now **LOCKED — CANONICAL**.
