...
source_basis: Validated individual registration, authorization, allocation, reassessment, and concrete Document Identifier allocation evidence, including the explicit `UNIR-ALLOCATION-ACT-001` reference declared by Universal Architecture for `DIUA-DIC-000002`, and the verified `UNIR-ALLOCATION-ACT-002` and `UNIR-ALLOCATION-ACT-003` allocation-act artifacts.
---
...
**Source Basis:** Validated individual registration, authorization, allocation, reassessment, and concrete identifier-allocation evidence established through R1–R5, including the explicit `UNIR-ALLOCATION-ACT-001` reference declared by Universal Architecture for `DIUA-DIC-000002`, and the verified `UNIR-ALLOCATION-ACT-002` and `UNIR-ALLOCATION-ACT-003` allocation-act artifacts.  
...
**Canonical Repository Path:** `00_System/40_Registries/10_UNIR/UNIR-REGISTRY-001_Universal_Naming_Identification_Registry_v1.1.md` — publication not yet performed  
...
This lock applies to `UNIR-REGISTRY-001 v1.1` as the current materialized registry-state artifact and supersedes v1.0 for current state representation. It does not alter, supersede, or reopen `UNIR-CORE-001 v1.3`, nor does it alter any underlying registration, allocation, authorization, reassessment, or historical record.
