...
**Parent Document:** `UNIR-REGISTRY-001 v1.4`  
...
`UNIR-REGISTRATION-RECORD-001 v1.4` is the successor revision incorporating the verified `DIUA-DIC-000005` and `DIUA-DIC-000006` allocations and supersedes `UNIR-REGISTRATION-RECORD-001 v1.2` as the current canonical registration-record representation.
