...
The immediately preceding published canonical revision was `UNIR-REGISTRATION-RECORD-001 v1.4`.

- **Published Commit:** `566d8dffb0cc26022e1edfe9441960b5ddf3604e`
- **Published Timestamp:** `2026-08-16T06:23:41Z`
- **Published Blob SHA:** `9f4b25de81b31b43c67cf64c7d136c94b3e52fe5`
...
### DIUA-DIC-000005 — Universal Production Knowledge Registry
...
This revision materializes the seventh concrete Document Identifier allocation for `UPKR-REGISTRY-001` based on the verified ACT-007 evidence. It does not create a UNIR Registry Object.
...
`UNIR-REGISTRATION-RECORD-001 v1.5` is the correction successor to published `UNIR-REGISTRATION-RECORD-001 v1.4`, incorporating the verified `DIUA-DIC-000005`, `DIUA-DIC-000006`, and `DIUA-DIC-000007` allocations.

---

## Appendix A — Verified Allocation Evidence

The following allocation act is incorporated as the documentary evidence basis for the `DIUA-DIC-000005` allocation represented in this Registration Record.
...
The incorporated act remains a distinct evidence artifact. Its inclusion here does not collapse the Allocation Act into the Registration Record, Registry Object, or Current Registry State.
...
Universal Production Knowledge Registry Registration Record
        ↓
UNIR-REGISTRATION-RECORD-001 v1.3
```
